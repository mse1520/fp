...
interface Map {
   ...
   * @returns new array.
   */
  <T, U>(predicate: (value: Awaited<T>, index: number) => U): (iterable: Iterable<T>) => U[] | Promise<U[]>;
  <T, U>(iterable: Iterable<T>, predicate: (value: Awaited<T>, index: number) => U): U[] | Promise<U[]>;
}
